...
| source mount           | --source-mount, -sm            |     kv-v2      |           |                                | name of the kv mount to read from                                              |
...
| destination mount      | --destination-mount, -dm       |     kv-v2      |           |                                | name of the kv mount to write to. default is same as --source-mount            |
